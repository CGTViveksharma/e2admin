...
<div class="wrap">
    ...
    if (Yii::$app->user->isGuest) {
        ...
        $menuItems[] =  '<li class="col-sm-5  language-action">'.
                                        Html::beginForm(['', 'id' => 'language_form'],'post',['data-url' => Url::toRoute('site/language')]).
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; E2 Admin <?= date('Y') ?></p>
